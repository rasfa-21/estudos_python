...
chamados = [
    ...
    {"fazenda": "Boa Vista", "valor": 1500, "tecnico": "Gabriel", "status": "Em aberto"},
    {"fazenda": "Semear", "valor": 1800, "tecnico": "Paulo", "status": "Concluído"},     
]   
...
with open(caminho, 'w', newline='', encoding='utf-8') as arquivo: # newline='' evita linhas em branco
    campos = ['fazenda', 'valor', 'tecnico', 'status']    # PRECISA bater com as chaves do dicionário        
    escritor = csv.DictWriter(arquivo, fieldnames=campos) # fieldnames precisa ter os mesmos nomes das chaves
